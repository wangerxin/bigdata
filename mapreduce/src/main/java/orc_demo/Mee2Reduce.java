 ...
 */
public class Mee2Reduce extends Reducer<Text,LongWritable,NullWritable,OrcStruct> {
    ...
    protected void reduce(Text key, Iterable<LongWritable> values, Context context) throws IOException, InterruptedException {
        ...
        msisdn_1.set(split[0]);
        msimsi_1.set(split[1]);
        msimei_1.set(split[2]);
        geohash6.set(split[3]);
