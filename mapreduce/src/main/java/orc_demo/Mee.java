...
public class Mee implements WritableComparable<Mee>{
    ...
    public Mee(String msisdn_1, String msimsi_1, String msimei_1, String geohash6, Long capture_time) {
        super();
